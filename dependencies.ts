...
export { serve } from "https://deno.land/std@0.128.0/http/mod.ts";
export type {
  Response,
  Server,
  ServerRequest,
...
export { readLines } from "https://deno.land/std@0.128.0/io/bufio.ts";
export { minifyHTML } from "https://deno.land/x/minifier@v1.1.1/mod.ts";
import { v4 as uuid } from "https://deno.land/std@0.128.0/uuid/mod.ts";
